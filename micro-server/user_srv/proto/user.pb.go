...
var file_user_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x74, 0x68, 0x44, 0x61, 0x79, 0x22, 0x24, 0x0a, 0x0a, 0x4d, 0x6f, 0x62, 0x69, 0x6c,
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x22, 0x18, 0x0a,
	0x06, 0x49, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x30, 0x0a, 0x08, 0x50, 0x61, 0x67, 0x65, 0x49,
	...
	0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xaf, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72,
	...
	0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a,
	...
	0x07, 0x2e, 0x49, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x11, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49,
...
var file_user_proto_depIdxs = []int32{
	...
	4, // 2: User.GetUserByMobile:input_type -> MobileInfo
	5, // 3: User.GetUserById:input_type -> IdInfo
...
type UserClient interface {
	...
	GetUserById(ctx context.Context, in *IdInfo, opts ...grpc.CallOption) (*UserInfoResponse, error)
...
func (c *userClient) GetUserById(ctx context.Context, in *IdInfo, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
...
type UserServer interface {
	...
	GetUserById(context.Context, *IdInfo) (*UserInfoResponse, error)
...
func (*UnimplementedUserServer) GetUserById(context.Context, *IdInfo) (*UserInfoResponse, error) {
...
func _User_GetUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserById(ctx, req.(*IdInfo))
	}
	return interceptor(ctx, in, info, handler)
}
